...
int main(void)
{
    ...
    printf("ft_isascii(100) = %d | isascii = %d\n", ft_isascii(100), isascii(100));
	...
	char *test_dup = ft_strdup("Test");
	char *test_dup2 = strdup("Test");
	...
	char	*test;
	test = ft_substr("Hello", 1, 3);
    printf("ft_substr = %s\n", test);
	free(test);
	char	*test1;
	test1 = ft_strjoin("Hello ", "World");
    printf("ft_strjoin = %s\n", test1);
	free(test1);
	char	*test2;
	test2 = ft_strtrim("--Hello--", "-");
    printf("ft_strtrim = %s\n", test2);
	free(test2);
